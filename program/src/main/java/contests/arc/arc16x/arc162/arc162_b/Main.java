 ...
 *
 * verified:
 * - https://atcoder.jp/contests/arc162/submissions/43274897
 *
 * note:
 * 操作を行うことで、転倒数の偶奇は変化しない。よって、奇数ならソート不可。
 * ソートが可能な時は、
 * ・１から順番に、要素と位置が同じ位置に来るように操作する。
 * ・着目した要素が一番後ろの場合、一度後ろ２つを一つ前にずらしてから再操作
 *
 */
